...
func opsRule0701() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0701",
		Name:           "food-lab-chain-service control 0701",
...
func opsRule0702() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0702",
		Name:           "food-lab-chain-service control 0702",
...
func opsRule0703() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0703",
		Name:           "food-lab-chain-service control 0703",
...
func opsRule0704() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0704",
		Name:           "food-lab-chain-service control 0704",
...
func opsRule0705() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0705",
		Name:           "food-lab-chain-service control 0705",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0706() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0706",
		Name:           "food-lab-chain-service control 0706",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0707() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0707",
		Name:           "food-lab-chain-service control 0707",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0708() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0708",
		Name:           "food-lab-chain-service control 0708",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       true,
	}
