...
func opsRule0601() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0601",
		Name:           "food-lab-chain-service control 0601",
...
func opsRule0602() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0602",
		Name:           "food-lab-chain-service control 0602",
...
func opsRule0603() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0603",
		Name:           "food-lab-chain-service control 0603",
...
func opsRule0604() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0604",
		Name:           "food-lab-chain-service control 0604",
...
func opsRule0605() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0605",
		Name:           "food-lab-chain-service control 0605",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0606() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0606",
		Name:           "food-lab-chain-service control 0606",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0607() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0607",
		Name:           "food-lab-chain-service control 0607",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0608() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0608",
		Name:           "food-lab-chain-service control 0608",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       true,
	}
