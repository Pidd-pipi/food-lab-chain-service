...
func opsRule0201() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0201",
		Name:           "food-lab-chain-service control 0201",
...
func opsRule0202() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0202",
		Name:           "food-lab-chain-service control 0202",
...
func opsRule0203() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0203",
		Name:           "food-lab-chain-service control 0203",
...
func opsRule0204() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0204",
		Name:           "food-lab-chain-service control 0204",
...
func opsRule0205() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0205",
		Name:           "food-lab-chain-service control 0205",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0206() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0206",
		Name:           "food-lab-chain-service control 0206",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0207() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0207",
		Name:           "food-lab-chain-service control 0207",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0208() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0208",
		Name:           "food-lab-chain-service control 0208",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       true,
	}
