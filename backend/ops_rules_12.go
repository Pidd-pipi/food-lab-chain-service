...
func opsRule1201() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1201",
		Name:           "food-lab-chain-service control 1201",
...
func opsRule1202() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1202",
		Name:           "food-lab-chain-service control 1202",
...
func opsRule1203() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1203",
		Name:           "food-lab-chain-service control 1203",
...
func opsRule1204() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1204",
		Name:           "food-lab-chain-service control 1204",
...
func opsRule1205() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1205",
		Name:           "food-lab-chain-service control 1205",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1206() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1206",
		Name:           "food-lab-chain-service control 1206",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1207() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1207",
		Name:           "food-lab-chain-service control 1207",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1208() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1208",
		Name:           "food-lab-chain-service control 1208",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       true,
	}
