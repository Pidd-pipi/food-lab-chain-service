...
func opsRule1401() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1401",
		Name:           "food-lab-chain-service control 1401",
...
func opsRule1402() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1402",
		Name:           "food-lab-chain-service control 1402",
...
func opsRule1403() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1403",
		Name:           "food-lab-chain-service control 1403",
...
func opsRule1404() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1404",
		Name:           "food-lab-chain-service control 1404",
...
func opsRule1405() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1405",
		Name:           "food-lab-chain-service control 1405",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1406() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1406",
		Name:           "food-lab-chain-service control 1406",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1407() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1407",
		Name:           "food-lab-chain-service control 1407",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1408() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1408",
		Name:           "food-lab-chain-service control 1408",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       true,
	}
