...
func opsRule0501() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0501",
		Name:           "food-lab-chain-service control 0501",
...
func opsRule0502() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0502",
		Name:           "food-lab-chain-service control 0502",
...
func opsRule0503() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0503",
		Name:           "food-lab-chain-service control 0503",
...
func opsRule0504() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0504",
		Name:           "food-lab-chain-service control 0504",
...
func opsRule0505() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0505",
		Name:           "food-lab-chain-service control 0505",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0506() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0506",
		Name:           "food-lab-chain-service control 0506",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0507() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0507",
		Name:           "food-lab-chain-service control 0507",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0508() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0508",
		Name:           "food-lab-chain-service control 0508",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       true,
	}
