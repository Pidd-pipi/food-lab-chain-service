...
func opsRule1001() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1001",
		Name:           "food-lab-chain-service control 1001",
...
func opsRule1002() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1002",
		Name:           "food-lab-chain-service control 1002",
...
func opsRule1003() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1003",
		Name:           "food-lab-chain-service control 1003",
...
func opsRule1004() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1004",
		Name:           "food-lab-chain-service control 1004",
...
func opsRule1005() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1005",
		Name:           "food-lab-chain-service control 1005",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1006() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1006",
		Name:           "food-lab-chain-service control 1006",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1007() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1007",
		Name:           "food-lab-chain-service control 1007",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1008() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1008",
		Name:           "food-lab-chain-service control 1008",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       true,
	}
