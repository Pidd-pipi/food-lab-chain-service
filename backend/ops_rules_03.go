...
func opsRule0301() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0301",
		Name:           "food-lab-chain-service control 0301",
...
func opsRule0302() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0302",
		Name:           "food-lab-chain-service control 0302",
...
func opsRule0303() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0303",
		Name:           "food-lab-chain-service control 0303",
...
func opsRule0304() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0304",
		Name:           "food-lab-chain-service control 0304",
...
func opsRule0305() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0305",
		Name:           "food-lab-chain-service control 0305",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0306() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0306",
		Name:           "food-lab-chain-service control 0306",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0307() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0307",
		Name:           "food-lab-chain-service control 0307",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0308() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0308",
		Name:           "food-lab-chain-service control 0308",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       true,
	}
