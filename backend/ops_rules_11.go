...
func opsRule1101() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1101",
		Name:           "food-lab-chain-service control 1101",
...
func opsRule1102() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1102",
		Name:           "food-lab-chain-service control 1102",
...
func opsRule1103() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1103",
		Name:           "food-lab-chain-service control 1103",
...
func opsRule1104() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1104",
		Name:           "food-lab-chain-service control 1104",
...
func opsRule1105() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1105",
		Name:           "food-lab-chain-service control 1105",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1106() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1106",
		Name:           "food-lab-chain-service control 1106",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1107() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1107",
		Name:           "food-lab-chain-service control 1107",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1108() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1108",
		Name:           "food-lab-chain-service control 1108",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       true,
	}
