...
func opsRule0401() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0401",
		Name:           "food-lab-chain-service control 0401",
...
func opsRule0402() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0402",
		Name:           "food-lab-chain-service control 0402",
...
func opsRule0403() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0403",
		Name:           "food-lab-chain-service control 0403",
...
func opsRule0404() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0404",
		Name:           "food-lab-chain-service control 0404",
...
func opsRule0405() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0405",
		Name:           "food-lab-chain-service control 0405",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0406() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0406",
		Name:           "food-lab-chain-service control 0406",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0407() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0407",
		Name:           "food-lab-chain-service control 0407",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0408() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0408",
		Name:           "food-lab-chain-service control 0408",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       true,
	}
