...
func opsRule0101() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0101",
		Name:           "food-lab-chain-service control 0101",
...
func opsRule0102() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0102",
		Name:           "food-lab-chain-service control 0102",
...
func opsRule0103() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0103",
		Name:           "food-lab-chain-service control 0103",
...
func opsRule0104() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0104",
		Name:           "food-lab-chain-service control 0104",
...
func opsRule0105() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0105",
		Name:           "food-lab-chain-service control 0105",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0106() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0106",
		Name:           "food-lab-chain-service control 0106",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0107() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0107",
		Name:           "food-lab-chain-service control 0107",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0108() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0108",
		Name:           "food-lab-chain-service control 0108",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       true,
	}
