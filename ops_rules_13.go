...
func opsRule1301() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1301",
		Name:           "food-lab-chain-service control 1301",
...
func opsRule1302() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1302",
		Name:           "food-lab-chain-service control 1302",
...
func opsRule1303() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1303",
		Name:           "food-lab-chain-service control 1303",
...
func opsRule1304() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1304",
		Name:           "food-lab-chain-service control 1304",
...
func opsRule1305() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1305",
		Name:           "food-lab-chain-service control 1305",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1306() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1306",
		Name:           "food-lab-chain-service control 1306",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1307() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1307",
		Name:           "food-lab-chain-service control 1307",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule1308() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-1308",
		Name:           "food-lab-chain-service control 1308",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       true,
	}
