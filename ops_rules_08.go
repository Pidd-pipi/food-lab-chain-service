...
func opsRule0801() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0801",
		Name:           "food-lab-chain-service control 0801",
...
func opsRule0802() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0802",
		Name:           "food-lab-chain-service control 0802",
...
func opsRule0803() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0803",
		Name:           "food-lab-chain-service control 0803",
...
func opsRule0804() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0804",
		Name:           "food-lab-chain-service control 0804",
...
func opsRule0805() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0805",
		Name:           "food-lab-chain-service control 0805",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0806() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0806",
		Name:           "food-lab-chain-service control 0806",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0807() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0807",
		Name:           "food-lab-chain-service control 0807",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0808() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0808",
		Name:           "food-lab-chain-service control 0808",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       true,
	}
