...
func opsRule0901() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0901",
		Name:           "food-lab-chain-service control 0901",
...
func opsRule0902() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0902",
		Name:           "food-lab-chain-service control 0902",
...
func opsRule0903() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0903",
		Name:           "food-lab-chain-service control 0903",
...
func opsRule0904() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0904",
		Name:           "food-lab-chain-service control 0904",
...
func opsRule0905() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0905",
		Name:           "food-lab-chain-service control 0905",
		Severity:       OpsPriorityHigh,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0906() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0906",
		Name:           "food-lab-chain-service control 0906",
		Severity:       OpsPriorityCritical,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0907() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0907",
		Name:           "food-lab-chain-service control 0907",
		Severity:       OpsPriorityLow,
		RequiredLabels: labels,
		Terminal:       false,
	}
...
func opsRule0908() OpsRule {
	...
	return OpsRule{
		Code:           "OPS-0908",
		Name:           "food-lab-chain-service control 0908",
		Severity:       OpsPriorityNormal,
		RequiredLabels: labels,
		Terminal:       true,
	}
